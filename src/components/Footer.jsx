                ...
                <div className="grid grid-cols-2 md:flex md:flex-row md:justify-between gap-6 md:gap-8 mb-8 md:mb-12">
                    ...
                    <div className="col-span-2 md:col-span-1 md:w-1/3">
                        ...
                        <div className="flex gap-3">
                            ...
                            <a href="https://www.instagram.com/legacy_traces_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target='_blank' className="p-2 rounded-full bg-gray-200 dark:bg-gray-800 hover:bg-primary hover:text-white transition-colors"><Instagram size={18} /></a>
