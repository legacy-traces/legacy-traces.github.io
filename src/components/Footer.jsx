                ...
                <div className="grid grid-cols-2 md:grid md:grid-cols-[2fr_1fr_1fr_1fr_2fr] gap-6 md:gap-8 mb-8 md:mb-12">
                    ...
                    <div className="min-w-0">
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-primary text-black px-3 md:px-5 py-2.5 md:py-3 rounded-lg font-bold hover:brightness-90 transition-all text-xs sm:text-sm max-w-full"
                        >
